...
/**
 * A [ViewChangeHandler] which animates the translation y based on the direction
 */
open class VerticalViewChangeHandler @JvmOverloads constructor(
    duration: Long = -1
